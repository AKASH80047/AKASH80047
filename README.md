...
- 💼 Currently working **Full-Time as a Flutter Developer at ACME INFOSOFT**, building scalable, high-performance cross-platform iOS & Android mobile applications.
- 🎓 **B.Tech Graduate in Computer Science & Engineering** from Galgotias College of Engineering & Technology (CGPA: 7.51).
- ⚙️ Skilled in **Clean Architecture**, **Riverpod 2.x**, **BLoC**, **Dio REST API Interceptors**, **Firebase Cloud Infrastructure**, and **Material 3 UI Design**.
- 🛠️ Integrated 25+ production REST APIs with bearer token refresh, retries, and offline-first persistence.
- ⚡ 30+ GitHub repositories built with modular DRY widgets, unit tests, and CI/CD discipline.
...
| **State Management** | <img src="https://img.shields.io/badge/Riverpod-007ACC?style=flat-square" /> <img src="https://img.shields.io/badge/BLoC-02569B?style=flat-square" /> <img src="https://img.shields.io/badge/Provider-4285F4?style=flat-square" /> |
| **Networking & Backend** | <img src="https://img.shields.io/badge/REST_APIs-0052CC?style=flat-square" /> <img src="https://img.shields.io/badge/Dio_Interceptors-0175C2?style=flat-square" /> <img src="https://img.shields.io/badge/Firebase-FFCA28?style=flat-square&logo=firebase&logoColor=black" /> <img src="https://img.shields.io/badge/Firestore-FFCA28?style=flat-square&logo=firebase&logoColor=black" /> |
...
#### 1. 🎵 [Feel Every Beat — Music & Audio Streaming App](https://github.com/AKASH80047/Feel-Every-Beat-)
- Production audio streaming application built with **Flutter**, **JustAudio**, **AudioService**, **Riverpod**, and REST APIs.
- Features background audio playback, lock screen media controls, playlist management, and audio caching.
...
- Multi-role examination app featuring timed test submissions, real-time score analytics, and Firebase authentication.

#### 5. 📅 [Employee Attendance Tracker](https://github.com/AKASH80047/Attendance-App)
- Enterprise attendance management system with GPS check-ins, leave management, and real-time Firestore database synchronization.
...
<img src="https://github-readme-stats.vercel.app/api?username=AKASH80047&show_icons=true&theme=tokyonight&hide_border=true&count_private=true" height="175" alt="Akash's GitHub Stats" />
<img src="https://github-readme-stats.vercel.app/api/top-langs/?username=AKASH80047&layout=compact&theme=tokyonight&hide_border=true&hide=html,css" height="175" alt="Akash's Top Languages" />
